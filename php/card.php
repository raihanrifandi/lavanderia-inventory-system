...
$sql_barang_masuk = "SELECT COUNT(*) as total FROM transaksi_barang_masuk";
...
$sql_barang_keluar = "SELECT COUNT(*) as total FROM transaksi_barang_keluar";
...
// Fetch total barang yang keluar dari tabel barang_keluar
$sql_barang_keluar = "SELECT COUNT(*) as total FROM jenis_barang";
$result_barang_keluar = $conn->query($sql_barang_keluar);
$row_barang_keluar = $result_barang_keluar->fetch_assoc();
$total_jenis_barang = $row_barang_keluar['total'];

// Fetch total barang yang keluar dari tabel barang_keluar
$sql_barang_keluar = "SELECT COUNT(*) as total FROM satuan_barang";
$result_barang_keluar = $conn->query($sql_barang_keluar);
$row_barang_keluar = $result_barang_keluar->fetch_assoc();
$total_satuan_barang = $row_barang_keluar['total'];

// Fetch total barang yang keluar dari tabel barang_keluar
$sql_barang_keluar = "SELECT COUNT(*) as total FROM lokasi_barang";
$result_barang_keluar = $conn->query($sql_barang_keluar);
$row_barang_keluar = $result_barang_keluar->fetch_assoc();
$total_lokasi_barang = $row_barang_keluar['total'];
